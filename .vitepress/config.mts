...
export default withMermaid({
  ...
  head: [
    [
      ...
      {
        rel: "icon",
        href: "/nuxoblivius-docs/nuxoblivius.png",
        type: "image/png",
      },
    ],
  ],
  ...
  themeConfig: {
        ...
        items: [
          {
            text: "Установка",
            link: "/release/setup",
            items: [{ text: "Nuxt", link: "/release/nuxt" }],
          },
          { text: "State Manager", link: "/release/state-manager" },
          {
            text: "Record (Запросы API)",
            items: [
              { text: "Базовые настройки", link: `/release/record/base` },
              {
                text: "Продвинутые настройки",
                link: `/release/record/advanced`,
              },
              {
                text: "Модуль: Трансформация",
                link: `/release/record/template`,
              },
              { text: "Модуль: Пагинация", link: `/release/record/pagination` },
              {
                text: "Модуль: Взаимствование",
                link: `/release/record/borrow`,
              },
    ...
    socialLinks: [
      ...
      {
        icon: "github",
        link: "https://github.com/NotElementImport/nuxoblivius-package",
      },
      {
        icon: {
    ...
    footer: {
      ...
      message: "2023-2025\nPower tool for creating project with Enjoy!",
    },
  },
});
